...
namespace NYCMADB
{
    ...
    public partial class NYCMAEntities : DbContext
    {
        ...
        public virtual DbSet<vwSalesStatisticsByMonthByNeighborhood> vwSalesStatisticsByMonthByNeighborhoods { get; set; }
        public virtual DbSet<vwSalesStatisticsByMonthByNeighborhoodByBuildingClass> vwSalesStatisticsByMonthByNeighborhoodByBuildingClasses { get; set; }
