    ...
    public class Lead
    {
        ...
        public static bool IsValidFilter(DAL.Filters filterdata)
        {
            return IsValidFilter(filterdata.zipcodes, filterdata.neighborhoods, filterdata.isvacant, filterdata.leadgrades, filterdata.buildingclasscodes,
                                 ...
                                 filterdata.servicer, filterdata.landmark, filterdata.hasFHA, filterdata.deedAge, filterdata.taxLiensSoldYear, 
                                 filterdata.taxLiensSoldTotal, filterdata.ownerLivingOrAge, filterdata.mortgageExistingOrAge);
        }
                                         ...
                                         string deedAge, string taxlienssoldyear, string taxlienssoldtotal, string ownerLivingOrAge, string mortgageExistingOrAge)
        {
            if (zipcodes == null && buildingclasscodes == null && counties == null &&
                ...
                unbuilt == null && servicer == null && landmark == null && hasFHA == null && deedAge == null && 
                taxlienssoldyear == null && taxlienssoldtotal == null && ownerLivingOrAge == null && mortgageExistingOrAge == null)
                return false;
            return true;
        }
    }
