//-----------------------------------------------------------------------
// <copyright file="Freddie.cs" company="Redq Technologies, Inc.">
...
namespace PropertyWebAPI.BAL
{
    ...
    /// </summary>
    public class FreddieMortgageDetails : NYCBaseResult
    {
        /// <summary>True if there is a Freddie Mac Mortgage</summary>
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public bool? isFreddieMortgage;
    }
    ...
    /// </summary>
    public static class Freddie
    {
        private const int RequestTypeId = (int)RequestTypes.FreddieMortgage;
