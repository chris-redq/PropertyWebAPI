...
namespace PropertyWebAPI.Controllers
{
    ...
    {
        // ../api/violations/3001670091/?externalRequestId=135&dobPenaltiesAndViolations=Y
        /// <summary>  
        ...
        public IHttpActionResult GetViolations(string propertyBBL, string externalReferenceId = "", string dobPenaltiesAndViolationsSummary = "Y")
        {
